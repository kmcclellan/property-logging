...
/// <summary>
/// A base implementation of a logger provider using <see cref="ILogCollector{TState}"/>.
/// </summary>
/// <typeparam name="TState">The log collector state type.</typeparam>
public abstract class CollectorLoggerProvider<TState> : ILoggerProvider, ISupportExternalScope
{
    ...
    protected abstract ILogCollector<TState> GetCollector(string category);
